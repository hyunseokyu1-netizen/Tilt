...
TILT: The Maze Puzzle ("the App") is developed and operated by Hyunseok Yu ("we", "our", or "us"). This Privacy Policy describes how we handle information in connection with your use of the App.
...
The App does not knowingly collect personal information from children under 13. If you believe a child has submitted information, please contact us immediately for removal.

### Changes to This Policy

We may update this policy from time to time. Changes take effect when posted here, indicated by an updated "Last updated" date. Continued use of the App after changes constitutes acceptance.
...
TILT: 미로 퍼즐("앱")은 유현석("당사")이 개발 및 운영합니다. 본 개인정보처리방침은 앱 이용과 관련하여 정보를 어떻게 처리하는지 설명합니다.
...
본 앱은 만 14세 미만 아동의 개인정보를 의도적으로 수집하지 않습니다. 아동이 정보를 제출했다고 판단되는 경우 즉시 삭제를 위해 연락해 주세요.

### 방침 변경

본 방침은 수시로 업데이트될 수 있습니다. 변경 사항은 위의 "최종 업데이트" 날짜 갱신으로 반영됩니다. 변경 후 앱을 계속 사용하면 개정된 방침에 동의한 것으로 간주됩니다.
...
*본 방침은 Google Play 스토어에 출시된 TILT: 미로 퍼즐 / TILT: The Maze Puzzle에 적용됩니다.*
